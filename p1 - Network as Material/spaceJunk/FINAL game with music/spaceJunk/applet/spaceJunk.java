...
public void setup() {
  ...
  test = new satellite(0, 225, 100, 100, 5);
  ...
  for (int i=0; i<numSatellites; i++) {
    mySatellites[i] = new satellite(-50, random(height), 100, 100, random(-4, 4));
  }
    ...
    for (int i=0; i<spaceJunkList.size(); i++) {
      for (int j=0; j<spaceJunkList.size(); j++) {
        ...
        if (d<((satellite1.circleSize+satellite2.circleSize)/2) && d>0) {
          ...
          //decrease size 
          if (satellite1.circleSize>2) satellite1.circleSize=tempSize1/1.05f;//decrease size of involved satellites
          if (satellite2.circleSize>2) satellite2.circleSize=tempSize2/1.05f;
          ...
          if (satellite1.split==true) { 
            ...
            int sound = PApplet.parseInt(random(4));
            if (sound < 2) {
              thud.play();
              thud.rewind();
...
public void drawBackground() {
  int c1 = color(120, 175, 205);
  int c2 = color(175, 205, 235);
...
class Event {
 ...
 Event(int _whichMessage) {
   ...
   y = PApplet.parseInt(random(0,height-85));
   collision = false;
...
class Message {
  ...
  Message() {
    ...
    randomMessage = PApplet.parseInt(random(1, 13));
    count = 0;
    fade = (0);
...
class Star {
 ...
 Star() {
   ...
   int r = PApplet.parseInt(random(220,240));
   int g = PApplet.parseInt(random(220,240));
   int b = PApplet.parseInt(random(200,220));
 ...
 public void display() {
   int twinkle = PApplet.parseInt(random(-5,5));
   brightness+=twinkle;
...
class satellite {
  ...
  satellite(float x, float y, float w, float l, float v) {
    ...
    int whichSatellite = PApplet.parseInt(random(1,5));
...
class Satellite2 {
  ...
  Satellite2(int _cx, int _cy) {
    ...
    cx = _cx;
    cy = _cy;
    orbitSize = PApplet.parseInt(random(110, 300));
    orbitTime = random(900.0f, 2000.0f);
    circleSize = PApplet.parseInt(random(5, 20));
  ...
  public void display() {
    ...
    x = PApplet.parseInt(cx+orbitSize*cos(t));
    y = PApplet.parseInt(cy+orbitSize*sin(t));
